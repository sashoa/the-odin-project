...
def englishNumber number
  ...
  left  = number
  write = left/100000000          # How many milions left to write out?
  left  = left - write*100000000  # Subtract off those milions.
  ...
  if write > 0
    ...
    # milions we have to write out. After we add "milions" to
  ...
  write = left/100            # How many thousands left to write out?
  left  = left - write*100  # Subtract off those thousands.
